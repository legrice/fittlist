...
const HOLDS: { t: string; s: string }[] = [
  ...
  {
    t: "Notifications",
    s: "The alerts waiting for you in the app, and, if you turn them on, a browser push subscription, Apple device token, or Firebase Android device token so your device can be reached. We store notification preferences and pending alerts to deliver them and retry temporary failures. Native push alerts are delivered through Apple Push Notification service on iPhone and Google Firebase Cloud Messaging on Android.",
  },
  {
    t: "Counts",
