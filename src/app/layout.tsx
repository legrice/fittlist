...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Apply the coach's dark-mode preference before first paint (no flash). */}
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{if(localStorage.getItem('fl-dark')==='1')document.documentElement.setAttribute('data-mode','dark')}catch(e){}",
          }}
        />
