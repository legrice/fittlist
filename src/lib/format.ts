...
export const STORY_THEMES: Record<StoryThemeId, StoryTheme> = {
  ...
  paper: { label: "Off-white and green", bg: "#FAFAF8", fg: "#000000", accent: "#9FE870", muted: "#405D16", faint: "#6B6B68", time: "#000000", lockup: "ink", lockupAccent: "#405D16" },
  iron: { label: "Dark brown and orange", bg: "#191502", fg: "#f4efe1", accent: "#C2410C", muted: "#c9c3ae", faint: "#8a8570", time: "#dad4be", lockup: "cloud" },
  moss: { label: "Olive and yellow-green", bg: "#4E4B3B", fg: "#F7F2E8", accent: "#CBD665", muted: "#C9C3AE", faint: "#A8A48E", time: "#E6E3D6", lockup: "cloud" },
  ...
  blush: { label: "Light pink and red", bg: "#f7dde2", fg: "#3d1b25", accent: "#c2385e", muted: "#8f6470", faint: "#b18f98", time: "#5c333f", lockup: "ink", lockupAccent: "#c2385e" },
  ...
  forest: { label: "Dark green and mint", bg: "#14312a", fg: "#eaf3ec", accent: "#8fd6a8", muted: "#9db8a9", faint: "#7d9a8c", time: "#d3e6d8", lockup: "cloud", lockupAccent: "#8fd6a8" },
  ...
  plum: { label: "Dark purple and pink", bg: "#3b1c3f", fg: "#f6ecf5", accent: "#f0a3c8", muted: "#b79ab6", faint: "#9a7d9a", time: "#e6d6e5", lockup: "cloud", lockupAccent: "#f0a3c8" },
  surf: { label: "Light teal and dark teal", bg: "#cfe9e4", fg: "#10322e", accent: "#0f6b5c", muted: "#5c7f7a", faint: "#7c9b96", time: "#1d423d", lockup: "ink", lockupAccent: "#0f6b5c" },
...
export const STORY_STYLES: Record<StoryStyleId, StoryStyle> = {
  plain: {
    label: "Classic",
    description: "Open, crisp, and unmistakably FittList",
    layout: "plain",
    theme: "paper",
    typeface: "standard",
    decoration: "top",
