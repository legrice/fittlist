...
// colour; defaults to brand purple for any generic use.
//
...
// or the mark drifts off-centre inside its purple square.
export function brandIcon(color = "#6D45D6"): string {
