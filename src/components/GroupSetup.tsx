...
import { addGroupClasses, inviteGroupPeople, updateGroupDescription, updateGroupVisibility, type GroupClassChoice } from "@/app/actions/groups";
import type { YouFavoritePerson } from "@/components/YouDashboard";
import { Icon } from "@/components/Icon";
import { Toast, useToast } from "@/components/Toast";

type View = "root" | "privacy" | "description" | "members" | "admins" | "classes";
type Member = { id: string; name: string; photo: string | null; color: string; role: string };

export function GroupSettings({ slug, name, description, visibility, people, members, classes }: { slug: string; name: string; description: string; visibility: "public" | "unlisted" | "private"; people: YouFavoritePerson[]; members: Member[]; classes: GroupClassChoice[] }) {
