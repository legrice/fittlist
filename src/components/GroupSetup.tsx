...
export function GroupSettings({ slug, name, photo, description, visibility, people, classes, pill=false }: { slug: string; name: string; photo: string | null; description: string; visibility: "public" | "unlisted" | "private"; people: YouFavoritePerson[]; classes: GroupClassChoice[]; pill?:boolean }) {
