...
import { joinOpenGroup, respondToGroupInvitation, toggleGroupFavorite } from "@/app/actions/groups";
import { useRouter } from "next/navigation";
import { Icon } from "@/components/Icon";
import { Toast, useToast } from "@/components/Toast";
import { SignupPrompt } from "@/components/SignupPrompt";

export function GroupActions({ slug, initialFavorite, manager, joined, joinable, invitationRole, children }: { slug: string; name: string; initialFavorite: boolean; manager: boolean; joined: boolean; joinable: boolean; invitationRole?: string | null; children?:ReactNode }) {
