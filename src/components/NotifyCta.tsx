          ...
          <div className="sheet">
            ...
            {waitlisted ? (
              <>
                ...
                <p className="lead">
                  We&rsquo;ve put <b>{email}</b> on {firstName}&rsquo;s list. Their schedule
                  still lands in your inbox every week.
                </p>
              ...
              <>
                ...
                <p className="lead">
                  Create an account while you&rsquo;re here: every coach you follow lands in one
