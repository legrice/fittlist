...
function BrandMark({ color }: { color: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
      viewBox="0 0 68.25 91"
      width="54"
      height="52"
      fill={color}
    >
      <path d="M0 70.25C0 69.1454 0.895431 68.25 2 68.25H22.75V91H2C0.89543 91 0 90.1046 0 89V70.25Z" />
      <path d="M22.75 45.5H43.5C44.6046 45.5 45.5 46.3954 45.5 47.5V66.25C45.5 67.3546 44.6046 68.25 43.5 68.25H22.75V45.5Z" />
      <path d="M0 24.75C0 23.6454 0.895431 22.75 2 22.75H22.75V45.5H2C0.89543 45.5 0 44.6046 0 43.5V24.75Z" />
      <path d="M22.75 22.75C22.75 10.1855 32.9355 0 45.5 0H66.25C67.3546 0 68.25 0.895431 68.25 2V20.75C68.25 21.8546 67.3546 22.75 66.25 22.75H22.75Z" />
    </svg>
  );
}
          ...
          >
            ...
            >
              ...
              <span style={{ display: "flex", alignItems: "center", gap: 16 }}>
                <BrandMark color={onPhoto ? "#DDFF55" : theme.lockupAccent ?? theme.accent} />
                <span
                  style={{
