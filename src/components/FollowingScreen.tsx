...
export function FollowingScreen({
  ...
  return (
    <>
      ...
      {calendarFollowing && classSheetDismissed && <BodyPortal><div className="calendar-revealed-controls single" aria-label="Calendar view"><div className="calendar-view-toggle" data-active={calendarView} role="group" aria-label="Calendar view"><button type="button" aria-pressed={calendarView === "day"} onClick={() => setCalendarView("day")}>Day</button><button type="button" aria-pressed={calendarView === "month"} onClick={() => setCalendarView("month")}>Month</button></div></div></BodyPortal>}
