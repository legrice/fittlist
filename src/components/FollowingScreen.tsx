  ...
  return (
    <>
      ...
      <section className="calendar-scope-hero"><header className="calendar-section-summary calendar-following-head">
        ...
        {!classSheetDismissed && <button type="button" className="calendar-summary-reveal" aria-label="Show everyone you follow" onClick={() => setClassSheetDismissed(true)}><Icon name="expand_more" size={25} /></button>}
