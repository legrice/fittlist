...
export function FollowingScreen({
  ...
  return (
    <>
      ...
      <section inert={classSheetDismissed} aria-hidden={classSheetDismissed} className={`calendar-scope-hero calendar-transition-surface${classSheetDismissed ? " is-schedule" : ""}${scopeTarget !== "following" ? " calendar-surface-leaving" : ""}${scopeSummaryEntering ? " calendar-surface-entering" : ""}`}>{scopeTarget !== "following" && <div className="calendar-scope-loading" role="status" aria-label="Loading calendar"><span aria-hidden="true" /><span aria-hidden="true" /><span aria-hidden="true" /></div>}<header className="calendar-section-summary calendar-following-head">
