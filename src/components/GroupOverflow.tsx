...
export function GroupOverflow({ id, slug, name, canReport, children }: { id:string; slug:string; name:string; canReport:boolean; children?:ReactNode }) {
