  ...
  return (
    <main className="studio-dashboard">
      ...
      <div className="studio-dashboard-grid">
        {registrationPro && <Link className="studio-dashboard-card" href={`${base}/registrations`} prefetch={false}><span className="studio-dashboard-card-icon"><Icon name="groups" size={28} /></span><span className="studio-dashboard-card-copy"><strong>Front desk</strong><small>Event signup, QR codes, attendee lists and check-in</small></span><Icon name="arrow_forward" size={22} /></Link>}
        ...
        <Link className="studio-dashboard-card" href={`${base}/staff`} prefetch={false}><span className="studio-dashboard-card-icon"><Icon name="groups" size={28} /></span><span className="studio-dashboard-card-copy"><strong>Staff</strong><small>{staffCount} {staffCount === 1 ? "person" : "people"} on your teaching team</small></span><Icon name="arrow_forward" size={22} /></Link>
        <Link className="studio-dashboard-card" href={`${base}/counts`} prefetch={false}><span className="studio-dashboard-card-icon"><Icon name="activity" size={28} /></span><span className="studio-dashboard-card-copy"><strong>Class counts</strong><small>Review teaching totals by month</small></span><Icon name="arrow_forward" size={22} /></Link>
      </div>
