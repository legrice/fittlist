...
export function CalendarScreen({
  ...
  return (
    <>
      ...
      {sheet ? <div className="calendar-bottom-actions" aria-label="Schedule actions"><button className="calendar-bottom-add" aria-label="Add to your schedule" onClick={openAdd}><Icon name="add" size={30} /></button></div> : classSheetDismissed && <BodyPortal><div className={`calendar-revealed-controls${returning ? " is-returning" : ""}`} aria-label="Calendar controls"><button className="calendar-add-pill" type="button" aria-label="Add to your calendar" onClick={openAdd}><Icon name="add" size={27} /></button></div></BodyPortal>}
