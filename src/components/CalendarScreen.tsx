...
const SUMMARY_VOICES: { value:SummaryVoice; label:string; description:string; emoji:string }[] = [
  ...
  { value:"unfiltered", label:"Unfiltered", description:"A bit of swearing. You asked for it.", emoji:"😜" },
  ...
  const calendarWeekSummary = useMemo(() => {
    ...
    if (summaryVoice === "friendly")
      ...
      if (totalScheduled === 0)
        ...
        title=variant([`${roastContext} Respectable, balanced, and annoyingly difficult to roast without inventing a personal crisis.`,`${roastContext} Busy enough to mention, not busy enough to become your entire personality, although you’ll certainly give it a try.`,`${roastContext} A perfectly solid week, which is inconvenient because I was prepared to make fun of either your laziness or your complete lack of boundaries.`,`${roastContext} Look at you occupying the exact middle ground between “I should move more” and “why did I agree to all of this?”`,`${roastContext} This is almost suspiciously reasonable. Please make one questionable scheduling decision so we have something interesting to discuss.`]);
      else
