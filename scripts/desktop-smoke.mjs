...
// the tabs, as header links, with the bottom bar gone
{
  ...
  // The same four everyone gets; only where You points differs.
  if (labels.join("|") !== "Plans|Following|Discover|You")
    fail(`a member's header links should be Plans, Following, Discover and You, got ${labels}`);
