...
// One wording for every band: "Tue, Aug 5", the comma by Matt's call.
// "Today" and "Tomorrow" led their own for a long time, which made two bands
// out of a fortnight read differently from the rest.
